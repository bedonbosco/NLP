...
* [NNVLP](http://nnvlp.org/) - Neural Network-Based Vietnamese Language Processing Toolkit *by Pham Thai Hoang (2017)* `demo`
...
* [ai.vitk.ner](https://github.com/phuonglh/ai.vitk.ner) - Vietnamese Named Entity Recognition *by Le Hong Phuong (Jul 2017)* `scala,java`
